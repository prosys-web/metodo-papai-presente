...
6. Suba (commit + push) para o GitHub. Com o GitHub Pages ativado, o episódio fica disponível em:
   `https://SEU-USUARIO.github.io/metodo-papai-presente/As-aventuras-de-Ester/episodes/episodio-0N/`

   *(Nota: o conteúdo está publicado dentro de uma subpasta extra `As-aventuras-de-Ester/` dentro do repositório. O link acima já reflete isso. Se essa subpasta um dia for removida — movendo tudo um nível acima — o link fica mais curto: `.../metodo-papai-presente/episodes/episodio-0N/`.)
