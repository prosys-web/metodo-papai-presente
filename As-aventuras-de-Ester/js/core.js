...
function hugCelebration(){
  ...
  const soundChoices = [ ()=>playSfx('success',[659,880,1318]), ()=>playSfx('magic-bell',[784,1046,1318]), ()=>chime([523,659,784,1046]) ];
